...
class ApplicationGenerator:
    ...
    def render_letter_variant(self, job: Dict[str, Any], variant_index: int) -> str:
        ...
        if is_formation:
            p4 = f"Dirigeant d'un organisme certifié Qualiopi (ICPF QUA007374), j'ai conçu de bout en bout un parcours de 758 heures préparant au Titre professionnel Gestionnaire de paie (TP-01254). Titulaire d'un Master 2 en Droit public et d'une Maîtrise en Sciences de Gestion, j'apporte une double expertise juridique et managériale garantissant des contenus rigoureusement actualisés. À 59 ans, j'offre un engagement loyal et pérenne, éligible aux aides à l'embauche senior. Titulaire du permis B, immédiatement disponible et mobile {loc_disp}, je serais honoré d'échanger avec vous lors d'un entretien."
        else:
            p4 = f"Dirigeant d'un organisme certifié Qualiopi où j'ai conçu un parcours de 758 heures préparant au Titre professionnel Gestionnaire de paie, je maîtrise la sécurisation des processus RH et de la paie. Titulaire d'un Master 2 en Droit public et d'une Maîtrise en Sciences de Gestion, j'assure une veille sociale rigoureuse pour sécuriser vos pratiques au quotidien (accords, procédures, audits). À 59 ans, j'offre un engagement loyal et durable, ouvrant droit aux aides à l'embauche senior. Titulaire du permis B, disponible et mobile {loc_disp}, je serais honoré de vous rencontrer lors d'un entretien approfondi."
